...
export default function Edit({ project }) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <PageHeading title={'Edit Project'} backBtn={true} backRoute={'projects.index'} />
            }
        >
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col items-start gap-3 mt-1 sm:flex-row sm:items-center">
                                        ...
                                        {project.image_path && !imagePreview && (
                                            <div className="md:col-span-2">
                                                <label className="block mb-1 text-sm font-medium text-white txt">Current Picture</label>
                                                <img
